 ...
 */
final class Version20210113142237 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE session (id INT AUTO_INCREMENT NOT NULL, schedule VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, jacket VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
